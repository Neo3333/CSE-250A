...
DATA_PATH = ''
TRAIN_3 = os.path.join(DATA_PATH, 'train3_oddYr.txt')
TRAIN_5 = os.path.join(DATA_PATH, 'train5_oddYr.txt')
TEST_3 = os.path.join(DATA_PATH, 'test3_oddYr.txt')
TEST_5 = os.path.join(DATA_PATH, 'test5_oddYr.txt')
